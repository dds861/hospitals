...
class GetLocalHospitalBySectionIdAndRegionIdUseCase(private val repository: LocalStorageRepository)
    ...
    override suspend fun useCaseFunction(input: RequestHospitalModel): ResponseHospitalModel {
        return repository.getHospitalsBySectionIdAndRegionId(input)
    }
}
